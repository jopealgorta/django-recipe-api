...
class PrivateRecipesAPITests(TestCase):
    """Test private endpoints from recipe API"""
    ...
    def test_retrieving_recipes(self):
        """Test that recipes are retrieved successfully"""
...
class RecipeImageUploadTests(TestCase):
    """Tests for uploading images to a recipe"""
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='The vegan curry')
        recipe2 = sample_recipe(user=self.user, title='The meat curry')
        tag1 = sample_tag(user=self.user, name='Vegan')
